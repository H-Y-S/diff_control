...
/*
 *	Beamline definitions here.
 */

#define	SPRING8_BEAMLINE	"bl38b1"
#define	BL38B1			1
...
//void    set_enetra4_host(char	*c);
//void    set_enetra4_port(int	port);
//void    enetra4_shutdown();
//void    ccd_bl_generic_cmd(int	next);
//void    util_3digit(char *s1,int val);
//void    util_copy_strip(char *s1,char *s2);
//void    mdc_process_input(int	next);
//void    local_beamline_control(char *buf);
//void    mdc_queue_init_command();
//void    send_status();
